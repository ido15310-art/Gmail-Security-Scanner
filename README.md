...
2. Create a new project named `Upwind-Security-Scanner`.
3. Replace the default code with the provided `Code.gs` and update the `appsscript.json` manifest.
4. **Important:** Enable the **Gmail API** under the "Services" tab (+).
5. Click **Deploy** > **Test Deployments**.
6. Install the Add-on and open any email in Gmail to see the scanner in action.
